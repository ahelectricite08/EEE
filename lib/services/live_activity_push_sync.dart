...
class LiveActivityPushSync {
  ...
  static Map<String, dynamic> _activityData(
    ...
    if (Platform.isIOS) {
      data['teamALogo'] = _iosLogo(logo1, prefs, isA: true, imageOpts: imageOpts);
      data['teamBLogo'] = _iosLogo(logo2, prefs, isA: false, imageOpts: imageOpts);
