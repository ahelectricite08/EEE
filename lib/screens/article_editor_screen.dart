              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text('+ Ajouter', style: GoogleFonts.barlow(
                      fontSize: 11, color: _kRed, fontWeight: FontWeight.w600)),
                  ),
                ),
              ],
            ),
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: hint,
        hintStyle: GoogleFonts.barlow(fontSize: 14, color: Colors.white24),
        filled: true,
