...
const _kHeader = Color(0xFF0F0F12);
const _kInput  = Color(0xFF16161A);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: [
            // Bouton retour si on peut revenir (navigué depuis home)
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    shape: BoxShape.circle,
                    border: Border.all(color: _kRed.withAlpha(60), width: 2),
                  ),
                  child: const Icon(Icons.lock_rounded, color: _kRed, size: 34),
                ),
                ...
                Text(
                  ...
                  style: GoogleFonts.barlow(fontSize: 14, color: Colors.white38, height: 1.6),
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: const Icon(Icons.tag_rounded, color: _kRed, size: 18),
          ),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(
                    'Membres connectés',
                    style: GoogleFonts.barlow(fontSize: 11, color: Colors.white30),
                  ),
                ],
              ),
            ],
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Aucun message pour l\'instant',
                    style: GoogleFonts.barlow(fontSize: 14, color: Colors.white24)),
                const SizedBox(height: 4),
                Text('Sois le premier à écrire !',
                    style: GoogleFonts.barlow(fontSize: 12, color: Colors.white12)),
              ],
            ),
          );
        }
                          ...
                          child: Row(
                            children: [
                              ...
                              if (ts != null)
                                Text(
                                  _fmtTs(ts!),
                                  style: GoogleFonts.barlow(fontSize: 10, color: Colors.white30),
                                ),
                            ],
                          ),
                        ),
              ...
              child: Row(
                children: [
                  const Padding(
                    ...
                    child: Icon(Icons.tag_rounded, size: 16, color: Color(0xFF44444A)),
                  ),
                  const SizedBox(width: 6),
                  Expanded(
                    child: TextField(
                      controller: ctrl,
                      style: GoogleFonts.barlow(fontSize: 14, color: Colors.white70),
                      decoration: InputDecoration(
                        hintText: 'Envoyer un message...',
                        hintStyle: GoogleFonts.barlow(fontSize: 14, color: const Color(0xFF3A3A42)),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 8),
          Text(label,
            style: GoogleFonts.barlow(fontSize: 12, color: Colors.white30)),
          const Spacer(),
          Text(value,
            style: GoogleFonts.barlow(
