              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text('CSSA', style: GoogleFonts.barlowCondensed(
  ...
  void _editReplay(BuildContext context, MatchModel match) {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Text('Lien replay', style: GoogleFonts.barlowCondensed(
...
// ── CLASSEMENT ────────────────────────────────────────────────────────────────
const _kSeasons = ['2024-2025', '2025-2026', '2026-2027'];
                ...
                child: GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: selected ? _kRed : const Color(0xFF2A2A2A),
                        width: 1,
                      ),
                    ...
                    child: Text(s,
                      style: GoogleFonts.barlow(
                        ...
                        color: selected ? _kRed : const Color(0xFF555555),
                      )),
                  ),
                ),
              );
                  ...
                  if (entries.isEmpty) {
                    return Center(
                      child: Text('Aucun classement pour $_season',
                        style: GoogleFonts.barlow(color: const Color(0xFF333333), fontSize: 14)),
                    );
                  }
...
class _LeagueLabel extends StatelessWidget {
  ...
  static const _compNames = {
    '2024-2025': 'Régional 2 · Grand Est',
...
class _ZoneLegend extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final topLabel = season == '2024-2025' ? 'Promotion' : 'Barrage';
    return Padding(
...
class _RankingHeader extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final s = GoogleFonts.barlowCondensed(
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border(
          ...
          bottom: const BorderSide(color: Color(0xFF1A1A1A), width: 0.5),
        ),
      ),
              ...
              child: Container(
                ...
                child: Text(entry.pts.toString(),
                  style: GoogleFonts.barlowCondensed(
                    ...
                    color: isCSSA ? Colors.white : Colors.white)),
              ),
            ),
          ),
        ],
...
class _TeamInitials extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width: 26, height: 26,
      decoration: BoxDecoration(
        color: logo != null ? Colors.white : (isCSSA ? _kRed.withAlpha(40) : const Color(0xFF1E1E1E)),
        borderRadius: BorderRadius.circular(6),
        border: Border.all(
          color: logo != null ? Colors.white : (isCSSA ? _kRed.withAlpha(100) : const Color(0xFF2A2A2A)),
          width: 1,
        ),
      ),
      child: logo != null
          ? Padding(
              ...
              child: Image.network(logo!, fit: BoxFit.contain,
                errorBuilder: (_, __, ___) => Center(child: Text(initials.toUpperCase(),
                  style: GoogleFonts.barlowCondensed(fontSize: 10,
                    fontWeight: FontWeight.w900, color: Colors.white38)))),
            )
          : Center(
              child: Text(initials.toUpperCase(),
                style: GoogleFonts.barlowCondensed(fontSize: 10,
                  fontWeight: FontWeight.w900,
                  color: isCSSA ? _kRed : Colors.white38)),
            ),
    );
  }
}
